...
from CEC2013.runner import run_experiment, write_comparison_csv, flush_all_csvs
...
Examples:
  ...
  python -m CEC2013.main --runs 10 --max-fes 50000  # Custom params
    ...
    # Write all accumulated CSVs (raw runs + master results + comparison)
    for algo_name in algo_names:
        flush_all_csvs(algo_name)
    print("Master CSVs written to results/{algo}/ directories")
